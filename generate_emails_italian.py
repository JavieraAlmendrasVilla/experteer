    ...
    with open(csv_file, 'r', encoding=encoding) as file:
        ...
        for row in csv_reader:
            ...
            candidate = {
                "name": full_name,
                "id": candidate_id,
                "job_title": row['Posizione attuale'],
                "company": row["Azienda"],
                "industry": row["Settore"],
                "email": row["Indirizzo email"],
                "phone": row["Numero di telefono"],
                "photo_url": photo_url,
                "profile_url": row["URL del profilo del candidato"],
            }
                            ...
                            <tbody>
                              <tr>
                                <td align="left"
                                  ...
                                  <div
                                    ...
                                    <strong>{number_candidates} candidati che vi piaceranno:</strong>
                                  </div>
                                </td>
                              </tr>
                              <tr>
                                <td align="center"
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="70%" border="0"
                                    ...
                                    <tr align="left" style="display: flex; display: flex; align-items: center;">
                                      ...
                                      <td text-align="left"><strong>corrispondono al</strong> profilo dei vostri requisiti </td>
                                    </tr>
                                    <tr align="left" style="display: flex; display: flex; align-items: center;">
                                      <td align="left" style="padding-right:1px;width:18px">
                                        <img style="width:18px; height:18px;margin-top: 6px;" width="18"
                                      ...
                                      <td text-align="left"><strong>interessati</strong> alla vostra posizione</td>
                                    </tr>
                                    <tr align="left" style="display: flex; display: flex; align-items: center;">
                                      <td align="left" style="padding-right:1px;width:18px">
                                        <img style="width:18px; height:18px;margin-top: 6px;" width="18"
                                      ...
                                      <td text-align="left"><strong>Pronti a parlare</strong> con voi </td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding-left:2px;word-break:break-word;">
                                  <div
                                    style="font-family:Lato;font-size:14px;font-style:normal;line-height:24px;text-align:left;color:#3B414A;">
                                    I candidati attendono un vostro riscontro!<strong> Contattateli ora!</strong>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
